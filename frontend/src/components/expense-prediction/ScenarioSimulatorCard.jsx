...
import { SlidersHorizontal, Sparkles, RefreshCw, ArrowRight, TrendingUp } from 'lucide-react';
        ...
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-normal">
              Simulate the effect of salary raises, bonus inflows, or lifestyle budget reductions.
            </p>
          </div>
        </div>
          ...
          >
            {simulating ? (
              ...
              <>
                ...
                <span>Calculate Scenario Outcome</span>
              </>
            )}
          </button>
        </div>
