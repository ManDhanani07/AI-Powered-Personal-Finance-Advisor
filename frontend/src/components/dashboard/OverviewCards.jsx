...
const CARDS = [
  {
    ...
    icon: Wallet,
    iconBg: 'border border-indigo-500/20 bg-transparent',
  ...
  },
  {
    ...
    icon: TrendingUp,
    iconBg: 'border border-emerald-500/20 bg-transparent',
  ...
  },
  {
    ...
    icon: TrendingDown,
    iconBg: 'border border-rose-500/20 bg-transparent',
  ...
  },
  {
    ...
    icon: PiggyBank,
    iconBg: 'border border-sky-500/20 bg-transparent',
