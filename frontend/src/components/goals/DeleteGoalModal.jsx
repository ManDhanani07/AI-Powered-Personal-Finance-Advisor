...
export const DeleteGoalModal = ({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.info(`Goal '${goal.goal_name}' deleted.`, { icon: '🗑️' });
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-red-100 dark:border-red-950">
            <div className="flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Delete Savings Goal</h3>
            </div>
            <button
              onClick={onClose}
          ...
          <p className="text-xs text-slate-600 dark:text-slate-400">
            Are you sure you want to delete <strong className="text-slate-900 dark:text-white">{goal.goal_name}</strong>?
            This will remove all target progress tracking for this goal.
          </p>
