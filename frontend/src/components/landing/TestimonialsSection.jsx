...
const TESTIMONIALS = [
  {
    ...
    avatar: 'AM',
    rating: 5,
    quote: 'Finally replaced scattered tracking tools with one platform. The AI Copilot answered my spending questions instantly, and the budget tracking helped me plan my home down payment.',
  ...
  },
  {
    ...
    avatar: 'RV',
    rating: 5,
    quote: 'As a freelancer with variable monthly income, the Cash Flow & Health Score is essential. It tracks my real-time runway and alerts me to potential spending risks.',
    highlight: 'Real-Time Financial Health',
