...
export const DeleteCategoryModal = ({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.info(`Category '${category.category_name}' deleted.`, { icon: '🗑️' });
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
        ...
        >
          ...
          <p className="text-xs text-slate-600 dark:text-slate-400">
            Are you sure you want to delete <strong className="text-slate-900 dark:text-white">{category.category_name}</strong>?
            Categories linked to active transactions cannot be deleted.
          </p>
