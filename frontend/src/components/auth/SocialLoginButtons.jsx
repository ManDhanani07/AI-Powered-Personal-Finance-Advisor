    ...
    <div className="space-y-2.5 w-full">
      ...
      <div className="grid grid-cols-2 gap-2.5">
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center justify-center gap-2 rounded-xl border border-zinc-800 bg-[#09090B] py-2 px-3 text-xs font-bold text-slate-200 transition-all hover:bg-zinc-900 hover:border-zinc-700 active:scale-[0.98] disabled:opacity-50 cursor-pointer"
        >
          {loading ? (
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-xl border border-zinc-800 bg-[#09090B] py-2 px-3 text-xs font-bold text-slate-200 transition-all hover:bg-zinc-900 hover:border-zinc-700 active:scale-[0.98] cursor-pointer"
        >
